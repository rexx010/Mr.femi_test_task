...
public class SundayMuchiesTest{
...
int a = SundayMunchies.findMultiple(num);
...
//test 5
System.out.print("Enter the digit your range wants to start from: ");
int num1 = input.nextInt();
System.out.print("Enter the digit your range wants to end: ");
int num2 = input.nextInt();
SundayMunchies.findMultipleof7Not5(num1, num2);
System.out.println();
